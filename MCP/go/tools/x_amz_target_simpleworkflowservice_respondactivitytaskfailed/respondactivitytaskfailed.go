...
func RespondactivitytaskfailedHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.RespondActivityTaskFailedInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SimpleWorkflowService.RespondActivityTaskFailed", cfg.BaseURL)
...
func CreateRespondactivitytaskfailedTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SimpleWorkflowService_RespondActivityTaskFailed",
	...
	return models.Tool{
		Definition: tool,
		Handler:    RespondactivitytaskfailedHandler(cfg),
	}
}
