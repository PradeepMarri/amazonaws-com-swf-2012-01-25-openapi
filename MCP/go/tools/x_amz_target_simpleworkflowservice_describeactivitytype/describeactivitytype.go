...
func DescribeactivitytypeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DescribeActivityTypeInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SimpleWorkflowService.DescribeActivityType", cfg.BaseURL)
		...
		var result models.ActivityTypeDetail
...
func CreateDescribeactivitytypeTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    DescribeactivitytypeHandler(cfg),
	}
}
