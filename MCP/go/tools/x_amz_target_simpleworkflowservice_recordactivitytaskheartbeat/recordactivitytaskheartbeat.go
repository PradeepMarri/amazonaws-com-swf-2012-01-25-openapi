...
func RecordactivitytaskheartbeatHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.RecordActivityTaskHeartbeatInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SimpleWorkflowService.RecordActivityTaskHeartbeat", cfg.BaseURL)
		...
		var result models.ActivityTaskStatus
...
func CreateRecordactivitytaskheartbeatTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    RecordactivitytaskheartbeatHandler(cfg),
	}
}
