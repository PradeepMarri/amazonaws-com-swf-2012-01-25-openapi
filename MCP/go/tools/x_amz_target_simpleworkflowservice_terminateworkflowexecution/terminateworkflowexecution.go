...
func TerminateworkflowexecutionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.TerminateWorkflowExecutionInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SimpleWorkflowService.TerminateWorkflowExecution", cfg.BaseURL)
...
func CreateTerminateworkflowexecutionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SimpleWorkflowService_TerminateWorkflowExecution",
	...
	return models.Tool{
		Definition: tool,
		Handler:    TerminateworkflowexecutionHandler(cfg),
	}
}
