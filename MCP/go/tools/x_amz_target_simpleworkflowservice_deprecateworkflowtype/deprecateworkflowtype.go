...
func DeprecateworkflowtypeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeprecateWorkflowTypeInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SimpleWorkflowService.DeprecateWorkflowType", cfg.BaseURL)
...
func CreateDeprecateworkflowtypeTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeprecateworkflowtypeHandler(cfg),
	}
}
