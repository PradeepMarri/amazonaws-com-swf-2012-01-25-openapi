...
func DeprecateactivitytypeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeprecateActivityTypeInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SimpleWorkflowService.DeprecateActivityType", cfg.BaseURL)
...
func CreateDeprecateactivitytypeTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeprecateactivitytypeHandler(cfg),
	}
}
