...
func RequestcancelworkflowexecutionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.RequestCancelWorkflowExecutionInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SimpleWorkflowService.RequestCancelWorkflowExecution", cfg.BaseURL)
