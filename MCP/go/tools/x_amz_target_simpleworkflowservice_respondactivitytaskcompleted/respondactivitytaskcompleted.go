...
func RespondactivitytaskcompletedHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.RespondActivityTaskCompletedInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SimpleWorkflowService.RespondActivityTaskCompleted", cfg.BaseURL)
