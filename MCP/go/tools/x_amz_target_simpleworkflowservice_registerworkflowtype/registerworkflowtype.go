...
func RegisterworkflowtypeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.RegisterWorkflowTypeInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SimpleWorkflowService.RegisterWorkflowType", cfg.BaseURL)
...
func CreateRegisterworkflowtypeTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SimpleWorkflowService_RegisterWorkflowType",
		...
		mcp.WithString("defaultLambdaRole", mcp.Description("")),
		mcp.WithString("domain", mcp.Required(), mcp.Description("")),
		mcp.WithString("defaultChildPolicy", mcp.Description("")),
		mcp.WithString("defaultExecutionStartToCloseTimeout", mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    RegisterworkflowtypeHandler(cfg),
	}
}
