...
func CountpendingdecisiontasksHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CountPendingDecisionTasksInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SimpleWorkflowService.CountPendingDecisionTasks", cfg.BaseURL)
...
func CreateCountpendingdecisiontasksTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    CountpendingdecisiontasksHandler(cfg),
	}
}
