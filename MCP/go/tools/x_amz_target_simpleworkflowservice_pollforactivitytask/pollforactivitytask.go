...
func PollforactivitytaskHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.PollForActivityTaskInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SimpleWorkflowService.PollForActivityTask", cfg.BaseURL)
		...
		var result models.ActivityTask
