...
func CountpendingactivitytasksHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CountPendingActivityTasksInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SimpleWorkflowService.CountPendingActivityTasks", cfg.BaseURL)
		...
		var result models.PendingTaskCount
