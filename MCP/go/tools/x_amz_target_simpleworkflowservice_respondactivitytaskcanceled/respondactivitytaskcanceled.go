...
func RespondactivitytaskcanceledHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.RespondActivityTaskCanceledInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SimpleWorkflowService.RespondActivityTaskCanceled", cfg.BaseURL)
...
func CreateRespondactivitytaskcanceledTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SimpleWorkflowService_RespondActivityTaskCanceled",
		...
		mcp.WithString("details", mcp.Description("")),
		mcp.WithString("taskToken", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    RespondactivitytaskcanceledHandler(cfg),
	}
}
