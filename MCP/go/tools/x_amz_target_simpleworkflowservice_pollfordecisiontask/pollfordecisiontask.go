...
func PollfordecisiontaskHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.PollForDecisionTaskInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SimpleWorkflowService.PollForDecisionTask%s", cfg.BaseURL, queryString)
		...
		var result models.DecisionTask
...
func CreatePollfordecisiontaskTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SimpleWorkflowService_PollForDecisionTask",
		...
		mcp.WithString("startAtPreviousStartedEvent", mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    PollfordecisiontaskHandler(cfg),
	}
}
