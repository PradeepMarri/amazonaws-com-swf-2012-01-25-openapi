...
func DeprecatedomainHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeprecateDomainInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SimpleWorkflowService.DeprecateDomain", cfg.BaseURL)
...
func CreateDeprecatedomainTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeprecatedomainHandler(cfg),
	}
}
