...
func UndeprecatedomainHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UndeprecateDomainInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SimpleWorkflowService.UndeprecateDomain", cfg.BaseURL)
...
func CreateUndeprecatedomainTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    UndeprecatedomainHandler(cfg),
	}
}
