...
func SignalworkflowexecutionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.SignalWorkflowExecutionInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SimpleWorkflowService.SignalWorkflowExecution", cfg.BaseURL)
...
func CreateSignalworkflowexecutionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SimpleWorkflowService_SignalWorkflowExecution",
		...
		mcp.WithString("signalName", mcp.Required(), mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    SignalworkflowexecutionHandler(cfg),
	}
}
