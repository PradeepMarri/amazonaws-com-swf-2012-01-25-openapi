...
func DescribeworkflowtypeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DescribeWorkflowTypeInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SimpleWorkflowService.DescribeWorkflowType", cfg.BaseURL)
		...
		var result models.WorkflowTypeDetail
...
func CreateDescribeworkflowtypeTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    DescribeworkflowtypeHandler(cfg),
	}
}
